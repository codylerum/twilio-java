...
public class Task extends NextGenInstanceResource<TwilioTaskRouterClient> {
     ...
     */
    public Map<String, Object> parseAttributes() throws JsonParseException, JsonMappingException, IOException {
    ...
    /**
     * The current priority score of the task, as assigned by the workflow. Tasks with higher values will be assigned before
